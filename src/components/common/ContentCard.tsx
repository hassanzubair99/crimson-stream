...
export function ContentCard({ item }: ContentCardProps) {
  ...
  return (
    <Link {...linkProps} className="block group">
      <Card className="overflow-hidden transition-all duration-300 ease-in-out hover:shadow-lg hover:shadow-primary/20 hover:scale-105 border-transparent bg-transparent">
